...
### Variables
We used *moistureValue* (read only variable) which receives values from the ESP8266 using the soil moisture sensor.
We used *moisturePerc* (read only variable on dashboard) calculated from the moistureValue.
